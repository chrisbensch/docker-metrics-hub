...
| Proxmox VE | prometheus-pve-exporter | central `9221` | `prometheus/targets/proxmox-hosts.yml` |
...
- Prometheus, Blackbox exporter, and Proxmox VE exporter stay bound to localhost unless you deliberately expose them.
